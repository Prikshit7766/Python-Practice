# now creating new tabe inside the same database
import pymongo
...
# here are creating the table but notdefining the structure of it
# that is we are storing diff diff features in the same table


# thats why is use for documents
# so we can store unstructured data also


record=collection1.find() # it is going to return all records
for i in record:
    print(i)
